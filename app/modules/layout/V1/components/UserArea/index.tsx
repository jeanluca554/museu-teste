...
export default function UserArea() {
  return (
    <div className="mt-auto pb-4">
      <Card className="border border-primary_gold-200 bg-primary_gold-50 dark:bg-neutral-900">
        <CardContent className="p-2 md:p-4 ">
          ...
          <div className="flex items-center gap-2 mt-3">
            ...
            <Button
              variant="ghost"
              className="w-full h-6 text-[10px] font-semibold bg-white text-primary_gold-900 border border-primary_gold-300 dark:bg-neutral-700 dark:text-neutral-100 dark:border-0"
            >
              <UserRound className="w-3 h-3 stroke-primary_gold-500 mr-2" />
              Minha Conta
            </Button>
            <Button
              variant="ghost"
              className="w-6 h-6 px-1 text-[10px] font-semibold bg-white text-primary_gold-900 border border-primary_gold-300 dark:border-0 dark:bg-neutral-700"
            >
              <LogOut className="w-3 h-3 stroke-rose-600" />
            </Button>
          </div>
        </CardContent>
      </Card>
